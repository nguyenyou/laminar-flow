---
title: ManualOwner
description: All this class does is expose the method to kill subscriptions.
---

```scala title="ManualOwner.scala"
...
[ManualOwner](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/ManualOwner.scala)