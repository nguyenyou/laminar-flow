---
title: TransferableSubscription
description: This subscription is hyper dynamic, allowing you to change DynamicOwner on the fly.
---

```scala title="TransferableSubscription.scala"
...
[TransferableSubscription](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/TransferableSubscription.scala)