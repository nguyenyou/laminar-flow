---
title: DynamicOwner
description: DynamicOwner manages [[DynamicSubscription]]-s similarly to how Owner manages `Subscription`s.
---

```scala title="DynamicOwner.scala"
...
[DynamicOwner](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/DynamicOwner.scala)