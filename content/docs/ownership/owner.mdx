---
title: Owner
description: Owner decides when to kill its subscriptions.
---

```scala title="Owner.scala"
...
[Owner](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/Owner.scala)