---
title: OneTimeOwner
description: Owner that can not be used after it was killed. Used in Laminar via DynamicOwner.
---

```scala title="OneTimeOwner.scala"
...
[OneTimeOwner](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/OneTimeOwner.scala)