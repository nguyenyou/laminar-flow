---
title: DynamicSubscription
description: Represents a subscription that can be turned on and off repeatedly.
---

```scala title="DynamicSubscription.scala"
...
[DynamicSubscription](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/DynamicSubscription.scala)