---
title: Subscription
description: Represents a leaky resource that needs to be cleaned up.
---

```scala title="Subscription.scala"
...
[Subscription](https://github.com/raquo/Airstream/blob/master/src/main/scala/com/raquo/airstream/ownership/Subscription.scala)